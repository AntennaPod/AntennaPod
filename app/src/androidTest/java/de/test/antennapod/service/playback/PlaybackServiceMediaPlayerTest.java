...
public class PlaybackServiceMediaPlayerTest {
    ...
    private Playable writeTestPlayable(String downloadUrl, String fileUrl) {
        ...
        FeedPreferences prefs = new FeedPreferences(f.getId(), false, FeedPreferences.AutoDeleteAction.NO, VolumeAdaptionSetting.OFF, FeedPreferences.SkipInboxSetting.NO, null, null);
