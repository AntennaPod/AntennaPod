...
import de.danoeh.antennapodSA.core.event.PlaybackPositionEvent;
import de.danoeh.antennapodSA.core.event.ServiceEvent;
...
import de.danoeh.antennapodSA.core.feed.SearchResult;
...
import de.danoeh.antennapodSA.core.receiver.MediaButtonReceiver;
...
import de.danoeh.antennapodSA.core.storage.FeedSearcher;
import de.danoeh.antennapodSA.core.util.IntentUtils;
import de.danoeh.antennapodSA.core.util.NetworkUtils;
import de.danoeh.antennapodSA.core.util.QueueAccess;
import de.danoeh.antennapodSA.core.util.gui.NotificationUtils;
...
public class PlaybackService extends MediaBrowserServiceCompat {
     ...
     */
    public static final String EXTRA_CAST_DISCONNECT = "extra.de.danoeh.antennapodSA.core.service.castDisconnect";
    /**
     * True if media should be streamed.
     */
    public static final String EXTRA_SHOULD_STREAM = "extra.de.danoeh.antennapodSA.core.service.shouldStream";
    public static final String EXTRA_ALLOW_STREAM_THIS_TIME = "extra.de.danoeh.antennapodSA.core.service.allowStream";
    public static final String EXTRA_ALLOW_STREAM_ALWAYS = "extra.de.danoeh.antennapodSA.core.service.allowStreamAlways";
    /**
     * True if playback should be started immediately after media has been
     * prepared.
     */
    public static final String EXTRA_START_WHEN_PREPARED = "extra.de.danoeh.antennapodSA.core.service.startWhenPrepared";

    public static final String EXTRA_PREPARE_IMMEDIATELY = "extra.de.danoeh.antennapodSA.core.service.prepareImmediately";

    public static final String ACTION_PLAYER_STATUS_CHANGED = "action.de.danoeh.antennapodSA.core.service.playerStatusChanged";
    private static final String AVRCP_ACTION_PLAYER_STATUS_CHANGED = "com.android.music.playstatechanged";
    private static final String AVRCP_ACTION_META_CHANGED = "com.android.music.metachanged";

    public static final String ACTION_PLAYER_NOTIFICATION = "action.de.danoeh.antennapodSA.core.service.playerNotification";
    public static final String EXTRA_NOTIFICATION_CODE = "extra.de.danoeh.antennapodSA.core.service.notificationCode";
    public static final String EXTRA_NOTIFICATION_TYPE = "extra.de.danoeh.antennapodSA.core.service.notificationType";

    /**
     * If the PlaybackService receives this action, it will stop playback and
     * try to shutdown.
     */
    public static final String ACTION_SHUTDOWN_PLAYBACK_SERVICE = "action.de.danoeh.antennapodSA.core.service.actionShutdownPlaybackService";
     ...
     */
    public static final String ACTION_SKIP_CURRENT_EPISODE = "action.de.danoeh.antennapodSA.core.service.skipCurrentEpisode";

    /**
     * If the PlaybackService receives this action, it will pause playback.
     */
    public static final String ACTION_PAUSE_PLAY_CURRENT_EPISODE = "action.de.danoeh.antennapodSA.core.service.pausePlayCurrentEpisode";

    /**
     * Custom action used by Android Wear
     */
    private static final String CUSTOM_ACTION_FAST_FORWARD = "action.de.danoeh.antennapodSA.core.service.fastForward";
    private static final String CUSTOM_ACTION_REWIND = "action.de.danoeh.antennapodSA.core.service.rewind";
