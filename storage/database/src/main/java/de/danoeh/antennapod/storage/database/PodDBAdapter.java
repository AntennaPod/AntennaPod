...
public class PodDBAdapter {
    ...
    public static final String KEY_FEED_SKIP_INBOX = "feed_skip_inbox";
    ...
    private static final String CREATE_TABLE_FEEDS = "CREATE TABLE "
            ...
            + KEY_FEED_SKIP_INBOX + " INTEGER DEFAULT 0)";
    ...
    private static final String KEYS_FEED =
            ...
            + TABLE_NAME_FEEDS + "." + KEY_FEED_SKIP_INBOX;
    ...
    public void setFeedPreferences(FeedPreferences prefs) {
        ...
        values.put(KEY_FEED_SKIP_INBOX, prefs.getSkipInboxSetting().ordinal());
