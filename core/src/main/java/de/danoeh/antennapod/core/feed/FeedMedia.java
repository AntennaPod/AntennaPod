...
public class FeedMedia extends FeedFile implements Playable {
    ...
    public boolean hasChapters() {
        return item.hasChapters();
    }

    public boolean shouldStopLoadingChapterMarks() {
        return item == null || item.getChapters() != null;
    }

    public boolean shouldLoadItem() {
        return item == null && itemID != 0;
    }
    ...
    public boolean shouldMarkItemAsPlayed() {
