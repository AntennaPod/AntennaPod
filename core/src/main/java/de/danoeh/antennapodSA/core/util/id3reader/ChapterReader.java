package de.danoeh.antennapodSA.core.util.id3reader;
...
import de.danoeh.antennapodSA.core.feed.ID3Chapter;
import de.danoeh.antennapodSA.core.util.id3reader.model.FrameHeader;
import de.danoeh.antennapodSA.core.util.id3reader.model.TagHeader;
