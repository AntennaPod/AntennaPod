...
import de.danoeh.antennapodSA.fragment.AllEpisodesFragment;
import de.danoeh.antennapodSA.fragment.DownloadsFragment;
import de.danoeh.antennapodSA.fragment.EpisodesFragment;
import de.danoeh.antennapodSA.fragment.NewEpisodesFragment;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v != null && viewType != VIEW_TYPE_SECTION_DIVIDER) {
            ...
            if (position == itemAccess.getSelectedItemIndex()) {
                ...
                v.getContext().getTheme().resolveAttribute(de.danoeh.antennapodSA.core.R.attr.drawer_activated_color, typedValue, true);
                v.setBackgroundResource(typedValue.resourceId);

            } else {
                txtvTitle.setTypeface(null, Typeface.NORMAL);
                v.getContext().getTheme().resolveAttribute(de.danoeh.antennapodSA.core.R.attr.nav_drawer_background, typedValue, true);
                v.setBackgroundResource(typedValue.resourceId);
            }
        }
        return v;
