...
import de.danoeh.antennapodSA.core.service.playback.PlayerStatus;
...
public class PlaybackPreferences implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     * object.
     */
    private static final String PREF_CURRENTLY_PLAYING_FEED_ID = "de.danoeh.antennapodSA.preferences.lastPlayedFeedId";
     ...
     */
    private static final String PREF_CURRENTLY_PLAYING_FEEDMEDIA_ID = "de.danoeh.antennapodSA.preferences.lastPlayedFeedMediaId";
     ...
     */
    private static final String PREF_CURRENTLY_PLAYING_MEDIA = "de.danoeh.antennapodSA.preferences.currentlyPlayingMedia";

    /**
     * True if last played media was streamed.
     */
    private static final String PREF_CURRENT_EPISODE_IS_STREAM = "de.danoeh.antennapodSA.preferences.lastIsStream";

    /**
     * True if last played media was a video.
     */
    private static final String PREF_CURRENT_EPISODE_IS_VIDEO = "de.danoeh.antennapodSA.preferences.lastIsVideo";

    /**
     * The current player status as int.
     */
    private static final String PREF_CURRENT_PLAYER_STATUS = "de.danoeh.antennapodSA.preferences.currentPlayerStatus";
     ...
     */
    private static final String PREF_CURRENTLY_PLAYING_TEMPORARY_PLAYBACK_SPEED = "de.danoeh.antennapodSA.preferences.temporaryPlaybackSpeed";
