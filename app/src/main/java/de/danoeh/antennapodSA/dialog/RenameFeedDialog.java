...
public class RenameFeedDialog {
    ...
    public void show() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(activity)
                .setView(content)
                .setTitle(de.danoeh.antennapodSA.core.R.string.rename_feed_label)
                .setPositiveButton(android.R.string.ok, (d, input) -> {
                    feed.setCustomTitle(editText.getText().toString());
                    DBWriter.setFeedCustomTitle(feed);
                })
                .setNeutralButton(de.danoeh.antennapodSA.core.R.string.reset, null)
                .setNegativeButton(de.danoeh.antennapodSA.core.R.string.cancel_label, null)
                .show();
