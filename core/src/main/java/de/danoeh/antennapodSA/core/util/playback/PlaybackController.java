...
import de.danoeh.antennapodSA.core.service.playback.PlaybackServiceMediaPlayer;
...
import de.danoeh.antennapodSA.core.util.playback.Playable.PlayableUtils;
            ...
            .subscribe(media -> {
                if (media.getMediaType() == MediaType.AUDIO) {
                    ...
                    getPlayButton().setImageResource(
                            res.getResourceId(0, R.drawable.ic_play_arrow_grey600_36dp));
                    res.recycle();
                } else {
